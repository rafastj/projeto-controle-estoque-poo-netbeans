 ...
 * @author Daniel
 */
public class GuiEnderecoNovoJD extends javax.swing.JDialog {
    
    public static Fachada fachada = new Fachada();

    /**
     * Creates new form GuiEnderecoNovoJD
     */
    public GuiEnderecoNovoJD(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GuiEnderecoNovoJD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                GuiEnderecoNovoJD dialog = new GuiEnderecoNovoJD(new javax.swing.JFrame(), true);
        ...
        jPanelNovoEnderecoLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelNovoEnderecoLayout.createSequentialGroup()
                ...
                .addGroup(jPanelNovoEnderecoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jTextFieldEntradaLog, javax.swing.GroupLayout.DEFAULT_SIZE, 330, Short.MAX_VALUE))
                .addContainerGap())
        );
