...
public class GuiFormaPagamento extends javax.swing.JDialog {
    ...
    private void btnSalvarMActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarMActionPerformed
        // TODO add your handling code here:
        // GuiSalvarFormaPagamento tela = new GuiSalvarFormaPagamento();
    ...
    private void formWindowGainedFocus(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowGainedFocus
     ...
     private DefaultTableModel geramodelo(ArrayList<FormaPagamento> listaTipo) {
    ...
    private void apagarFormaPagamento() {
        ...
        try {
            ...
            if (resposta == JOptionPane.YES_OPTION) {
                ...
                if (mConsult != null) {
                    fachada.excluirTipo(m.getFormaPagamento_Codigo());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GuiFormaPagamento8.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                GuiFormaPagamento8 dialog = new GuiFormaPagamento8(new javax.swing.JFrame(), true);
