...
public class Main {
	...
	/**
	 * Diego Silva Teste de Salvar
	 * Teste de Salvar Produto na tabela Produtos Utilizando as camadas
	 */
	...
	/**
	 * AREA ESCRITA POR FELIPE CARLOS
	 * RESPONSAVEL PELAS CLASSES tipo e marca.
	 */
	//teste salvar
	public static void testeSalvarTipo(){
		/*Tipo t = new Tipo(1,"AAAA");
		try{
