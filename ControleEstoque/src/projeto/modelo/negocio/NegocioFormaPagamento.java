...
public class NegocioFormaPagamento {
	...
	/**
	 * Contrutor inicializa o atributo "rep"
	 ...
	 * este método usa Exceptions para transmitir mensagens entre as camadas
	 * do sistema (negocio -> apresentação)
	 */
	...
	/**
	 * Verificar os dados antes de excluir a Forma de Pagamento
	 * este método usa Exceptions para transmitir mensagens entre as camadas
	 * do sistema (negocio -> apresentação)
	 */
	...
	public Collection<FormaPagamento> listarFormasPagamentos(
		...
		try {
			lista = (ArrayList<FormaPagamento>) new RepositorioFormaPagamento()
					.listarFormasPagamentos(formaPagamento_Descricao);
