...
public class RepositorioProduto_Fornecedor implements IRepositorioProduto_Fornecedor {
	...
	/**
	 * Implementação padão DAO para Salvar o fornecedor de Produto na tabela produtos_fornecedores
	 */
	...
	/**
	 * Implementação padão DAO para consultar o codigo produto na tabela produtos_fornecedores
	 */
	...
	/**
	 * Implementação padão DAO para EXCLUIR o codigo produto na tabela produtos_fornecedores
	 */
	...
	/**
	 * Implementação padão DAO para ALTERAR o codigo produto na tabela produtos_fornecedores
	 */
