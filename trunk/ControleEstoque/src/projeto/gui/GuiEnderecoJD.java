 ...
 * @author Daniel
 */
public class GuiEnderecoJD extends javax.swing.JDialog {

    ArrayList<Endereco> listaEndereco = null;
    public static Fachada fachada = new Fachada();

    /**
     * Creates new form GuiEnderecoJD
     */
    public GuiEnderecoJD(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GuiEnderecoJD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                GuiEnderecoJD dialog = new GuiEnderecoJD(new javax.swing.JFrame(), true);
