...
public class Cliente {
    ...
    /*
     * public Cliente (String clientes_NumeroResidencia, String clientes_Tipo,
     * int enderecos_Codigo) { this.clientes_NumeroResidencia =
     * clientes_NumeroResidencia; this.clientes_Tipo = clientes_Tipo;
