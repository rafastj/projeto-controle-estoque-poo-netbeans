...
public class Fachada {
	...
	/**
	 * AREA ESCRITA POR DIEGO SILVA
	 * RESPONSAVEL PELAS CLASSES Produto, Produto_Fornecedor, NotaFiscal_Produto.
	 * --PRODUTO--
	 */
	...
	/**
	 * Diego Silva Consultar informando primeiro o nome do fornecedor e depois o tal produto
	...
	/**
	 * AREA ESCRITA POR Thiago Evoa
	 * RESPONSAVEL PELAS CLASSES Usuario, Funcionario, NotaFiscal.
	 */
	...
	/**
	 * ÁREA ESCRITA POR Felipe
	 * RESPONSAVEL PELAS CLASSES Tipos, Marcas.
	 */
	...
	/**
	 * ÁREA ESCRITA POR Bruno Pinheiro
	 * RESPONSAVEL PELAS CLASSES Segemento, FormaPagamento.
	 */
