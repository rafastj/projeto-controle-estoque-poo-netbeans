 ...
 */
	...
	/**
	 * Imprementação padrão DAO para alteração da tabela Produtos
	 */
	...
	/**
	 * Imprementação padrão DAO para consultar pela Descrição da tabela Produtos
	 */
	...
	/**
	 * Imprementação padrão DAO para consultar pelo Codigo da tabela Produtos
	 */
	...
	/**
	 * Imprementação padrão DAO para listar pela descrição informada da tabela Produtos
	 */
